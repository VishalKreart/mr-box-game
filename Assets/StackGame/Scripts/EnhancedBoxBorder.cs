...
public class EnhancedBoxBorder : MonoBehaviour
{
    ...
    public bool enhancePhysics = true;
    public float physicsEnhancement = 0.02f; // How much to enlarge the collider
    ...
    public void CreateBorder()
    {
        ...
        {
            originalColliderSize = originalCollider.size;
        }
        ...
        // Enhance physics collider
        if (enhancePhysics && originalCollider != null)
        {
            EnhanceCollider();
        }
    ...
    void CreateBorderObject()
    {
        ...
        {
            // Adjust border scale to account for parent scale
    ...
    void EnhanceCollider()
    {
        // Enlarge the original collider slightly to create natural separation
        originalCollider.size = originalColliderSize + Vector2.one * physicsEnhancement * 2;
    }
    ...
    // Method to restore original collider size (useful for cleanup)
    public void RestoreOriginalCollider()
    {
        if (originalCollider != null)
        {
            originalCollider.size = originalColliderSize;
        }
    }
} 